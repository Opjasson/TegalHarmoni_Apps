...
const Home: React.FC<props> = ({ navigation }) => {
    ...
    const fetchData = async () => {
        const response = await fetch("change-your-IP-addressWLX/hotel/7");
    ...
    const fetchData2 = async () => {
        const response2 = await fetch("change-your-IP-addressWLX/wisata/7");
    ...
    const fetchData3 = async () => {
        const response3 = await fetch("change-your-IP-addressWLX/kuliner/8");
