...
const Home: React.FC<props> = ({ navigation }) => {
    ...
    const fetchData = async () => {
        const response = await fetch("http://192.168.200.220:5000/hotel/7");
    ...
    const fetchData2 = async () => {
        const response2 = await fetch("http://192.168.200.220:5000/wisata/7");
    ...
    const fetchData3 = async () => {
        const response3 = await fetch("http://192.168.200.220:5000/kuliner/8");
